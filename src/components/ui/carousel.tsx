  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          {children}
          <CarouselIndicators totalSlides={api?.scrollSnapList().length || 0} />
        </div>
      </CarouselContext.Provider>
    );
  }
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        !canScrollPrev ? "bg-dark-purple" : "bg-primary",
        className
      )}
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        !canScrollNext ? "bg-dark-purple" : "bg-primary",
        className
      )}
