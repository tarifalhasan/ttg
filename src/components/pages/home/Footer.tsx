...
const Footer = () => {
  ...
  return (
    <footer className="   px-4 sm:px-4 py-12 lg:px-10 2xl:container 2xl:px-10 flex justify-between flex-col lg:flex-row  lg:items-center">
      <div className=" space-y-6  lg:max-w-72 flex flex-col justify-between">
        <div className=" space-y-6">
          <Link href={"/"}>
            <Image src={"/images/logo.svg"} alt="ttr" width={179} height={34} />
          </Link>
      ...
      <div className=" gap-9 flex  flex-col  md:flex-row md:items-start">
        <div>
          ...
          <ul className=" pt-4 space-y-4">
            {SDATA.map((data, index) => (
              <li key={index} className=" text-base font-normal text-[#606060]">
                {data}
              </li>
            ))}
          </ul>
        ...
        <div>
          ...
          <ul className=" pt-4 space-y-4">
            ...
            <li className=" text-base font-normal text-[#606060]">financiar</li>
